      ...
      <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-sm md:p-8">
        {step === 0 && (
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Field label="Expected selling price (₹ INR)">
              <Input
                type="number"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Field label="Transmission">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, transmission: v })}
            ...
            <Field label="Registration state">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, registrationState: v })}
                options={STATES}
              />
            </Field>
            ...
            <Field label="Insurance status">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, insuranceStatus: v })}
                options={["Active", "Expired", "Expires soon", "None"]}
              />
            </Field>
            <Field label="Road tax status">
              <SelectV
                value={f.roadTaxStatus}
                onChange={(v) => setF({ ...f, roadTaxStatus: v })}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Field label="Service history">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, serviceHistory: v })}
                options={[
            ...
            <Field label="Accident history">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, accidentHistory: v })}
            ...
            <Field label="Exterior condition">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, exteriorCondition: v })}
            ...
            <Field label="Interior condition">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, interiorCondition: v })}
                options={["Excellent", "Very Good", "Good", "Fair"]}
              />
            </Field>
            <Field label="Engine condition">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, engineCondition: v })}
            ...
            <Field label="Tire condition">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, tireCondition: v })}
            ...
            <Field label="Battery condition">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, batteryCondition: v })}
            ...
            <div className="md:col-span-2">
              <Field label="Known defects or damages">
                <Textarea
                  rows={3}
                  value={f.defects}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Field label="Preferred contact time">
              <SelectV
                ...
                onChange={(v) => setF({ ...f, preferredContactTime: v })}
