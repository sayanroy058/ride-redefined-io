      ...
      <div className="rounded-2xl border border-border/60 bg-card p-8 shadow-sm print:border-0 print:shadow-none">
        ...
        <Section title="Inspection score">
          <div className="flex items-center gap-3 rounded-xl border border-success/30 bg-success/5 p-4">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">200-point inspection by certified engineers</div>
            </div>
          </div>
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={label} className="flex items-center gap-2 rounded-lg border border-border/60 p-3 text-sm">
        ...
        <Section title="Defects summary">
          <div className="space-y-2">
            {defectsList.map((d, i) => (
              <div key={i} className="flex items-start gap-3 rounded-lg border border-border/60 p-3 text-sm">
                <div
        ...
        <div className="mt-6 border-t border-border/60 pt-4 text-center text-xs text-muted-foreground">
          This report was generated by DriveHub on {new Date().toLocaleDateString()}. This is a
          demo document and does not represent a legal vehicle history certificate.
        </div>
      </div>
    </div>
  );
